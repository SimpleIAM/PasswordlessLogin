...
namespace Microsoft.AspNetCore.Builder
{
    ...
    {
        public static IApplicationBuilder UsePasswordlessLogin(this IApplicationBuilder app, IHostingEnvironment env, HostingConfig hostingConfig)
        {
            if (app == null)
            {
            ...
            if (!hostingConfig.SkipContentSecuritySetup)
            {
                ...
                app.UseMiddleware<SimpleIAM.PasswordlessLogin.Extensions.CspHeaderOverridesMiddleware>();
            }
