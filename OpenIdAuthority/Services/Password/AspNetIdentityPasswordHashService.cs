...
// Derived from https://github.com/aspnet/Identity/blob/85f8a49aef68bf9763cd9854ce1dd4a26a7c5d3c/src/Core/PasswordHasher.cs
...
namespace SimpleIAM.OpenIdAuthority.Services.Password
{
    ...
    public class AspNetIdentityPasswordHashService : IPasswordHashService
    {
        /* =======================
        ...
        public AspNetIdentityPasswordHashService(int iterationCount)
        {
        ...
        public virtual CheckPaswordHashResult CheckPasswordHash(string passwordHash, string password)
        {
            ...
            switch (decodedHashedPassword[0])
            {
                ...
                case 0x01:
                    ...
                    if (VerifyHashedPasswordV3(decodedHashedPassword, password, out embeddedIterCount))
                    {
