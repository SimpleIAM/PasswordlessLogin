...
IF NOT EXISTS(SELECT * FROM [auth].[__PasswordlessMigrationsHistory] WHERE [MigrationId] = N'20200128052520_v0.6.0')
BEGIN
    IF SCHEMA_ID(N'auth') IS NULL EXEC(N'CREATE SCHEMA [auth];');
END;
...
IF NOT EXISTS(SELECT * FROM [auth].[__PasswordlessMigrationsHistory] WHERE [MigrationId] = N'20200128052520_v0.6.0')
BEGIN
    CREATE TABLE [auth].[TrustedBrowsers] (
        [Id] int NOT NULL IDENTITY,
        [SubjectId] nvarchar(36) NOT NULL,
        [BrowserIdHash] nvarchar(max) NOT NULL,
...
BEGIN
    ...
    VALUES (N'20200128052520_v0.6.0', N'3.1.1');
END;
